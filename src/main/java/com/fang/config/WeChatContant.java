...
public class WeChatContant {
    //APPID
    public static final String appID = "wxa8ad5e9b52268539";
    //appsecret
    public static final String appsecret = "1bbfcf73beb1f67aa43e3131f6a0bf57";
    // EncodingAESKey LzPS5qTL4QMHUOyA5hnhAxxQ0WU4hLXQKmSBiNpjscF
    // Token
    public static final String TOKEN = "Fwj";
